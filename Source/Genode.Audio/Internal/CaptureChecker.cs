...
namespace Genode.Internal.OpenAL
{
    ...
    public static class CaptureChecker
    {
        ...
        /// </summary>
        internal static AlcError LastError { get; private set; }
        ...
        /// <summary>
        /// Initializes a static instance of the <see cref="CaptureChecker"/> class.
        /// </summary>
        ...
        /// </summary>
        /// <param name="device">Audio capture device to check.</param>
        /// <param name="action">Function to call.</param>
        public static void Check(AudioCapture device, Action action)
        {
            action();
            @checked = false;
